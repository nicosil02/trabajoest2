...
A pesar de no contar con errores en la asignación de factores, las asignaciones propias de R carecen de sentido en algunos casos. Por ejemplo, en el FAC2, se agrupan a confianza en policía junto con variables que son de confianza interpersonal. Estos podrían agruparse por separado para obtener mayor precisión sobre la explicabilidad de los factores.

De esta forma, a continuación se va a proponer un nuevo modelo que permita construir una distribución de patrones adecuada para explicar la confianza institucional.
