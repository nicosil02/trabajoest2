...
-   ¿Qué variables aportaron mas a los factores?
    -   Las variables confianza en organizaciones de mujeres y confianza en organizaciones ambientales
...
-   **¿Qué variables contribuyen a mas de un factor?**
    -   Las variables de confianza en servicio civil y confianza en elecciones contribuyen a más de un factor, poniendo en evidencia que estas instituciones están muy presentes en la opinión de las personas. Probablemente se explica que en varias partes del mundo estas instituciones tienen dificultades para instaurar su legitimidad en un contexto mundial de dacaimiento del orden liberal democrático, considerando que las elecciones y la burocracia son el corazón del sostenimiento de la democracia. (Repucci y Slipowitz, 2021)
...
```{r}
Modelo_confir2 = "FAC1 =~confianza_prensa+confianza_television
FAC2 =~ confianza_policia+confianza_FFAA
                 FAC3  =~ confianza_gobierno+confianza_partidos+confianza_parlamento+confianza_elecciones+confianza_serviciocivil + confianza_justicia
FAC4=~ confianza_sindicatos + confianza_granempresa+
...
1.  **F1 - Confianza en los medios de comunicación** (Incluye confianza en: televisión y prensa)

2.  **F2 - Confianza en las Instituciones Políticas y Legales** (Incluye confianza en: gobierno, partidos políticos, parlamento, mecanismos electorales, servicio civil, cortes de justicia)

3.  **F3 - Confianza en las Instituciones de Seguridad** (Incluye confianza en: policía y fuerzas armadas)

4.  **F4 - Confianza en Instituciones Sociales** (Incluye confianza en: sindicatos, grandes empresas, organizaciones ambientales, organizaciones de mujeres, organizaciones humanitarias/caridad)

[La sustentación de los factores se muestra a continuación:]{.underline}

**F1 - Confianza en los medios de comunicación**
...
**F2 - Confianza en las Instituciones Políticas y Legales**
...
texto: describir cada factor Estandarizamos del 1 al 4
...
map2= ggplot(cluster_map2)+ geom_sf(aes(fill = cluster_inter), lwd = 0.2) +
  geom_sf_text(aes(label =NAME), size = 2, family = "sans", fontface = "bold", check_overlap = TRUE) + scale_fill_manual(values = c("#CAFF70","#9ACD32", "#556B2F" ), labels = c("Confianza alta", "Confianza moderada", "Confianza baja")) +
