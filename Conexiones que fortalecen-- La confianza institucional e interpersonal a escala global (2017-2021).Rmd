...
De acuerdo con el análisis del gráfico de sedimentacion, ubicamos que el codo se encuentra en el 3. Al verificar en el otro cuadro se recomienda que se utilice 0 factores.
...
```{r message=FALSE, warning=FALSE}
Modelo_confir2 = "FAC1_Confianza institucional=~FAC1 =~confianza_gobierno+confianza_granempresa+confianza_parlamento+confianza_partidos+confianza_sindicatos+confianza_television+confianza_serviciocivil+confianza_prensa+confianza_bancos+confianza_org_ambiental+confianza_org_mujeres+confianza_elecciones+confianza_org_humanitaria+confianza_justicia+confianza_FFAA+confianza_policia
FAC2_Confianza interpersonal =~ conocidos+nacionalidad+rconocidos+barrio+preligion+familia"
Modelo_confir2
...
```{r message=FALSE, warning=FALSE}
Modelo_confir3 = "FAC1_Confianza institucional=~FAC1 =~confianza_gobierno+confianza_granempresa+confianza_parlamento+confianza_partidos+confianza_sindicatos+confianza_television+confianza_serviciocivil+confianza_prensa+confianza_bancos+confianza_org_ambiental+confianza_org_mujeres+confianza_elecciones+confianza_org_humanitaria+confianza_justicia+confianza_FFAA+confianza_policia
FAC2_Confianza interpersonal =~ conocidos+nacionalidad+rconocidos+barrio+preligion"
Modelo_confir3
